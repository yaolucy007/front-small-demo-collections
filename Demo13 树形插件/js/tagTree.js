...
;(function($){
	...
	function setTree(data,that)
	{
		...
		$.each(data,function(index,value){
			var li = $('<li><span>'+value.name+'<i data-val="'+value.value+'" class="fa fa-check" style="display:none;">查看</i></span></li>');
			ul.append(li);
			li.append('<div class="node-count">添加</div>');
			li.append('<div class="node-count">修改</div>');
			li.append('<div class="node-count">删除</div>');
